                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <form action="{{ route('addEvent-admin') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input id="startDate" type="datetime" class="form-control{{ $errors->has('startDate') ? ' is-invalid' : '' }}" name="startDate" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input id="endDate" type="datetime" class="form-control{{ $errors->has('endDate') ? ' is-invalid' : '' }}" name="endDate" required>
